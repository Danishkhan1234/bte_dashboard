                            ...
                            <div class="col s12">
                                <div class="card">
                                    <div class="card-content">
                                        <h1 class="card-title" style="font-size: 30px;">Contract Types</h1>
                                        <br> 
                                        <div class="row">
                                            <div class="col s12">
                                                <div id="page-length-option_wrapper" class="dataTables_wrapper">
                                                    <div class="dataTables_length" id="page-length-option_length">
                                                        <a href="{{route('admin.contract_type.create')}}" class="waves-effect waves-light btn gradient-45deg-light-red z-depth-4 mr-1 mb-2" type="submit" name="action">Create Contract Type
                                                   ...
                                                   @endif
                                                    ...
                                                    <thead>
                                                        <tr role="row">
                                                            ...
                                                            <th class="sorting_asc" tabindex="0" aria-controls="page-length-option" rowspan="1" colspan="1" style="width: 200px;" aria-sort="ascending" aria-label="Name: activate to sort column descending">Contract Name</th>
                                                    ...
                                                    <tbody>
                                                        @foreach ($contract_types as $contract_type)
                                                            ...
                                                            <td tabindex="0" class="sorting_1">{{$contract_type['id']}}</td>
                                                            <td>{{$contract_type['name']}}</td>
                                                            <td>{{$contract_type['created_at']}}</td>
                                                            <td>{{$contract_type['updated_at']}}</td>
                                                            <td>
                                                                <form action="{{route('admin.contract_type.delete',$contract_type['id'])}}" method="POST">
                                                                    @csrf
                                                                    @method('delete')
                                                                    <a class="waves-effect waves-light btn gradient-45deg-light-blue-cyan z-depth-4 mr-1 mb-2" href="{{route('admin.contract_type.edit',$contract_type['id'])}}">Edit</a>
