                            ...
                            <div class="col s12">
                                <div class="card">
                                    <div class="card-content">
                                        <h1 class="card-title" style="font-size: 30px;">Payment Type</h1>
                                        <br> 
                                        <div class="row">
                                            <div class="col s12">
                                                <div id="page-length-option_wrapper" class="dataTables_wrapper">
                                                    <div class="dataTables_length" id="page-length-option_length">
                                                        <a href="{{route('admin.payment_type.create')}}" class="waves-effect waves-light btn gradient-45deg-light-red z-depth-4 mr-1 mb-2" type="submit" name="action">Create Payment Type
                                                   ...
                                                   @endif
                                                    ...
                                                    <tbody>
                                                        @foreach ($payment_types as $payment_type)
                                                            ...
                                                            <td tabindex="0" class="sorting_1">{{$payment_type['id']}}</td>
                                                            <td>{{$payment_type['name']}}</td>
                                                            <td>{{$payment_type['created_at']}}</td>
                                                            <td>{{$payment_type['updated_at']}}</td>
                                                            <td>
                                                                <form action="{{route('admin.payment_type.delete',$payment_type['id'])}}" method="POST">
                                                                    @csrf
                                                                    @method('delete')
                                                                    <a class="waves-effect waves-light btn gradient-45deg-light-blue-cyan z-depth-4 mr-1 mb-2" href="{{route('admin.payment_type.edit',$payment_type['id'])}}">Edit</a>
