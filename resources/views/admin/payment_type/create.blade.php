                            ...
                            <div class="col s12">
                                <div class="card">
                                    <div class="card-content">
                                        <h1 class="card-title" style="font-size: 30px;">Create Payment Type</h1>
                                        <br> 
                                        <div class="row">
                                            <div class="col s12">
                                                <div id="page-length-option_wrapper" class="dataTables_wrapper">
                                                    ...
                                                    <div id="view-input-fields" class="active">
                                                        <div class="row">
                                                            <div class="col s12">
                                                                <form class="row" action="{{route('admin.payment_type.store')}}" method="post">
                                                                    @csrf
                                                                    <div class="col s12">
                                                                ...
                                                                <div class="row">    
                                                                    <button type="submit" class="left mt-3 mb-4 ml-2 btn waves-effect waves-light gradient-45deg-purple-deep-orange">Add Payment Type</button>
                                                                </div>
                                                                    </div>
                                                                </form>
                                                            </div>
