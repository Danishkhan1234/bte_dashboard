...
@section('content')
      ...
      <a style="border-radius:30px;" class="btn dropdown-button indigo waves-effect waves-light " href="#!" data-activates="dropdown1">Action<i class="mdi-navigation-arrow-drop-down right"></i></a>
                                    </td>           
